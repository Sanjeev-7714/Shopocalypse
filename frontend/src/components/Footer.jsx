      ...
      <div className='flex flex-col sm:grid grid-cols-[3fr_1fr_1fr] gap-14 my-10 mt-40 text-sm'>
        ...
        <div>
            <div className="flex items-center gap-2 mb-5">
              ...
              <h2 className="text-2xl font-bold prata-regular">
        ...
        <div>
            ...
            <ul className='flex flex-col gap-1 text-gray-600'>
                ...
                <li>contact@shopocalypse.com</li>
            </ul>
        </div>
        ...
        <div>
            <hr />
            <p className='py-5 text-sm text-center'>Copyright 2024@ Shopocalypse.com - All Right Reserved.</p>
        </div>
